...
# Minimal ANSI color helper — upstream omicverse imports this from
# ``omicverse._settings``; we inline just the four codes this module
# actually uses so the standalone mirror has no external dependency.
class Colors:
    BLUE = "\033[94m"
    GREEN = "\033[92m"
    WARNING = "\033[93m"
